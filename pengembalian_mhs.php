    ...
    <div class="nav row justify-content-evenly text-center align-items-center">
      <div class="col-sm-6">
        <div class="card text-bg-secondary mb-3">
          <div class="card-body">
            <h3 class="card-title fw-bold">FORMULIR PENGEMBALIAN ALAT LABORATORIUM</h3>
      ...
      <div class="col-sm-6">
        <form action="simpan_pengembalian.php" method="post">
          ...
          <div class="form-row mt-3">
            <div class="form-group">
              <label>Id Alat</label>
              <select class="form-select" name="idalat" class="idalat">
          ...
          <div class="form-row mt-3">
            <div class="form-group">
              ...
              <input type="text" name="tgl_pinjam" class="form-control" id="input_from" placeholder="Start Date" style="width: 180px;">
            </div>
            <div class="form-group mt-2">
              <label for="input_from"><i class="fa-solid fa-calendar-days"></i> Tanggal Pengembalian</label>
              <input type="text" name="tgl_kembali" class="form-control" id="input_to" placeholder="End Date" style="width: 180px;">
            </div>
          </div>
